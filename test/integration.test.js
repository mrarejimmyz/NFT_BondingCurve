// Test script for the BondingCurve NFT platform
...
async function testCreateCollection() {
  ...
  const collectionData = {
    ...
    description: "A test collection for the BondingCurve platform",
...
async function testMintNFT(collectionId) {
  ...
  const nftData = {
    name: "Test NFT #1",
    description: "A test NFT for the BondingCurve platform",
    collectionId,
...
async function testPriceCalculation(marketCap, basePrice, growthFactor) {
  ...
  console.log(
    `Market Cap: ${marketCap}, Base Price: ${basePrice}, Growth Factor: ${growthFactor}`
  );
...
async function testThresholdDetection() {
  ...
  console.log(
    `Market Cap: ${marketCap}, Threshold Reached: ${thresholdReached}`
  );
...
async function runTests() {
  try {
    console.log("Starting BondingCurve platform tests...");
