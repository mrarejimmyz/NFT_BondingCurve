...
export default function CreateNFT() {
  ...
  const [activeTab, setActiveTab] = useState<"collection" | "nft">(
    "collection"
  );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Create on BondingCurve</h1>
      ...
      <div className="mb-8">
        <div className="flex border-b border-gray-200 dark:border-gray-800">
          ...
          <button
            className={`${activeTab === "nft" ? "tab-active" : "tab-inactive"}`}
      ...
      {activeTab === "collection" ? (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
          ...
          <form onSubmit={handleCreateCollection}>
            ...
            <div className="mb-4">
              <label htmlFor="collectionDescription" className="label">
                Description
              </label>
              <textarea
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div>
                <label htmlFor="growthFactor" className="label">
                  Growth Factor
                </label>
                <input
                  id="growthFactor"
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mb-6">
              <h3 className="text-md font-medium text-yellow-800 dark:text-yellow-200 mb-2">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
          ...
          <form onSubmit={handleCreateNFT}>
            <div className="mb-4">
              <label htmlFor="nftName" className="label">
                NFT Name
              </label>
              <input
                id="nftName"
            ...
            <div className="mb-4">
              <label htmlFor="nftDescription" className="label">
                Description
              </label>
              <textarea
                id="nftDescription"
